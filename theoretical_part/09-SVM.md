...
<p style="align:center"><img src="./pngs/SVM_17.png" style="zoom:40%; "/></p>
...
2. 如果处理特征数远大于样本数的情况，核心还是要做预处理。或者在数据预处理阶段，对数据进行降维，特征选择，等等方式，让数据的维度降下来；或者增加数据量，让样本数升上去；或者二者兼有。完全靠算法本身处理这个问题并不靠谱。依然是，数据预处理是时间机器学习过程中非常重要的一步。
...
<p style="align:center"><img src="./pngs/SVM_18.png" style="zoom:20%; "/></p>
